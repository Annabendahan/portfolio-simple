      ...
      <div>
        ...
        <div className="main">
          ...
          <div className="section">
            ...
            <p className="">
              PARIS BASED FREELANCE DEVELOPER FOR 2 YEARS NOW, I AM SPECIALISED
              IN FRONT-END DEVELOPEMENT. BECAUSE A SUCCESSSFUL PROJECT COMBINES
              ART & TECHNOLOGY, MY GOAL IS TO CREATE MODERN & EFFICIENT
              WEBSITES, WHICH ARE NICE AND USER FRIENDLY.{" "}
            </p>
          </div>
          <div className="section ">
            <ScrollAnimation animateIn="fadeIn">
